...
namespace Eman_Maet.CompanyController
{
    ...
    public class CompanyController : ControllerBase
    {
        ...
        //[HttpGet]
        //public ActionResult<List<CompanyModel>> GetAll()
        //{
        //    using (MySqlConnection connection = new MySqlConnection(defaultConnection))
        //    {
        //        IEnumerable<CompanyModel> output = connection.Query<CompanyModel>("SELECT * FROM COMPANY");
        //        return output.ToList();
        //    }
        //}

        //[HttpGet("{id}", Name = "GetCOMPA ")]
        //public ActionResult<CompanyModel> GetById(string id)
        //{

        //    using (MySqlConnection connection = new MySqlConnection(defaultConnection))
        //    {
        //        IEnumerable<CompanyModel> output = connection.Query<CompanyModel>("SELECT * FROM COMPANY WHERE Id=(@_id)", new { _id = id });
        //        if (output.Count() == 0)
        //        {
        //            return NotFound();
        //        }
        ...
        //public ActionResult<List<CompanyModel>> GetByRange(float min, float max)
        //{

        //    using (MySqlConnection connection = new MySqlConnection(defaultConnection))
        //    {
        //        IEnumerable<CompanyModel> output = connection.Query<CompanyModel>("SELECT * FROM COMPANY WHERE Gpa>=(@_min) AND Gpa<=(@_max)", new { _min = min, _max = max });
        //        if (output.Count() == 0)
        //        {
        //            return NotFound();
        //        }
